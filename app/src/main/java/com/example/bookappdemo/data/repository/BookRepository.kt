...
//            if (bookCount > 0L) return@write
            ...
            val book1 = copyToRealm(Book().apply {
                ...
                detail = BookDetail().apply {
                    ...
                    images = realmListOf(
                        ...
                        ImageInfo().apply {
                            url = "https://www.harpercollins.com/cdn/shop/files/9780547249643.jpg?v=1757675146"
                            type = "gallery"
                        },
                        ImageInfo().apply {
                            url = "https://pro2-bar-s3-cdn-cf6.myportfolio.com/d898e1369ef62545efef48866827b472/0e43328defcd01ddd666b919_rw_1920.jpg?h=dc5ea6d25a86b2eb2592968bea81d047"
                            type = "gallery"
                        }
                    )
                }
            ...
            val book2 = copyToRealm(Book().apply {
                ...
                detail = BookDetail().apply {
                    ...
                    images = realmListOf(
                        ImageInfo().apply {
                            url = "https://cdn2.penguin.com.au/covers/original/9780141036137.jpg"
                            type = "cover"
                        },
                        ImageInfo().apply {
                            url = "https://cdn2.penguin.com.au/covers/original/9780140817690.jpg"
                            type = "gallery"
                        },
                        ImageInfo().apply {
                            url = "https://cdn2.penguin.com.au/covers/original/9781473581586.jpg"
                            type = "gallery"
                        }
                    )
                }
